      ...
      if (!r && (C(e), (e = e || T), E)) {
        if (11 !== d && (u = Z.exec(t)))
          if ((i = u[1])) {
            ...
            if (
              (i = u[3]) &&
              p.getElementsByclassNameName &&
              e.getElementsByclassNameName
            )
              return O.apply(n, e.getElementsByclassNameName(i)), n;
          }
        if (
          p.qsa &&
          !k[t + ' '] &&
      ...
      function (e) {
        ...
        return (
          r != T &&
            ...
            (p.getElementsByclassNameName = J.test(
      ...
      toggleclassName: function (i, t) {
        ...
        return 'boolean' == typeof t && a
          ...
          : this.each(function () {
              ...
              } else (void 0 !== i && 'boolean' !== o) || ((e = it(this)) && Y.set(this, '__classNameName__', e), this.setAttribute && this.setAttribute('className', e || !1 === i ? '' : Y.get(this, '__classNameName__') || ''));
            });
      },
