  ...
  Y._set('doughnut', {
    ...
    legendCallback: function (t) {
      var e,
        ...
        o = r.datasets,
        s = r.labels;
      if ((a.setAttribute('className', t.id + '-legend'), o.length))
  ...
  Y._set('global', {
    ...
    legendCallback: function (t) {
      var e,
        ...
        r = t.data.datasets;
      for (
        a.setAttribute('className', t.id + '-legend'), e = 0, n = r.length;
        e < n;
        e++
      )
        ((i = a.appendChild(document.createElement('li'))).appendChild(
